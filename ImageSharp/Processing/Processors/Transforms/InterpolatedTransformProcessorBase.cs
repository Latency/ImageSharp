...
namespace SixLabors.ImageSharp.Processing.Processors
{
        ...
        where TPixel : struct, IPixel<TPixel>
    {
        ...
        protected (double radius, double scale, double ratio) GetSamplingRadius(int sourceSize, int destinationSize)
        {
            ...
            double value = scale * this.Sampler.Radius;

            return (MathF.Ceiling(value), scale, ratio);
        }
    }
}